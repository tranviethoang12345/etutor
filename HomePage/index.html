...
<html lang="en">
<head>
<title>ETutor Education</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="eTutor Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<div class="top-head container">
		<div class="ml-auto text-right right-p">
			<ul>
				...
				<li>
					<span class="fa fa-envelope-open"></span> <a href="mailto:info@example.com">eTutor@gmail.com</a> </li>
			</ul>
		</div>
	</div>
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href="index.html"><img src="images/s2.png" alt=""> ETutor </a></h1>
			</div>
			...
			<ul class="menu ml-auto mt-1">
				...
				<li class=""><a href="../LoginPage/Login.php">Login</a></li>
			</ul>
		</nav>
		<!-- //nav -->
	</div>
		...
		<div class="container py-md-3">
			<div class="footer-grid_section text-center">
				<div class="footer-title mb-3">
					<a href="#"><img src="images/s2.png" alt=""> ETutor</a>
				</div>
