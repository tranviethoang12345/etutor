...
left join classrooms as c on s.id = c.student_id
        ...
        <div class="row">
            <section class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="post"  action="AddNewClassAction.php" >   
                    ...
                    <tbody>
                            <?php 
                                if($databaseResponse->num_rows > 0) {
                                    $arr =  $databaseResponse->fetch_all(MYSQLI_ASSOC);
                                    foreach($arr as $s) {
                                        echo "<tr>";
                                        echo "<td>" . $s['tutor_fullname'] . "</td>";
                                         echo "<td>" . $s['student_fullname'] . "</td>";
                                         echo "<td><a href='delete.php?id=".$s['classroom_id']."'>delete</a></td>";
                                         echo "</tr>";
                                    }
                                } 
                             ?>
