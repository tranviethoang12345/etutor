                ...
                <div class="panel panel-default">
                    ...
                    <div>
                      <table class="table" >
                        ...
                        <tbody>
                            <?php 
                                    if ($databaseResponseToGetClassrooms->num_rows > 0) {
                                        while($row = $databaseResponseToGetClassrooms->fetch_assoc()) {
                                            $count = getCount($row['id']);
                                            echo "<tr>";
                                            echo "<td>" . $row['name'] . "</td>";
                                            // echo "<td>" . $row['name'] . "</td>";
                                            // echo "<td>" . $row['name'] . "</td>";
                          ...
                          <!-- <tr>
                            ...
                            <td>student1</td>
                            <td>
                                <a href="editClass.html"><i class="fas fa-edit" style="font-size:24px;color: green;"></i></a>
